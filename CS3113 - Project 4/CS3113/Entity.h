...
public:
    ...
    void update(float deltaTime, Entity *player, Map *map, 
        Entity *collidableEntities, int collisionCheckCount,  Entity *enemies[] = nullptr, int enemyCount = 0);
    void render();
    ...
    bool isCollidingWithEnemy(Entity* enemies[], int enemyCount); // New function added to check collisions from the players perspective 
